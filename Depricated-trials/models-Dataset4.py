...
withbaby_data = np.load('withscarfbaby_npy_array4.npy')
...
plt.title('Confusion Matrix - MLPClassifier (Dataset 4)')
plt.xlabel('Predicted Label')
plt.ylabel('True Label')
plt.savefig('mlp_dataset4_confusion_matrix_DS4.png')
plt.show()
...
sns.heatmap(conf_matrix_rf, annot=True, fmt='d', cmap='Blues_r', cbar=False,
            xticklabels=['No Babydoll', 'With Babydoll'], yticklabels=['No Babydoll', 'With Babydoll'])
plt.title('Confusion Matrix - RandomForestClassifier (Dataset 4)')
plt.xlabel('Predicted Label')
plt.ylabel('True Label')
plt.savefig('random_forest_dataset4_confusion_matrix_DS4.png')
plt.show()
...
plt.savefig('mlp_vs_rf_roc_curve_DS4.png')
plt.show()
...
plt.savefig('mlp_vs_rf_precision_recall_curve_DS4.png')
plt.show()
...
# Show plot
plt.tight_layout()
plt.savefig('label_distribution_bar_graph_combined_DS4.png')
plt.show()
